...
class Game():
    ...
    def __init__(self):
        ...
        Game.npc_path = Game.path("sprites", "NPCs")
        ...
        NPC((500, 1768), Game.npc_path, Game.camera)
...
class Camera(pygame.sprite.Group):
    ...
    def custom_draw(self, player):
        ...
        while spriteListLen > i:
            ...
            if NPC.hit(Player) == False and obj == "MsgBox":
...
class Pause():
    ...
    def mainmenu_screen(self):
        ...
        if keys[pygame.K_w] or (Game.gamepadInputs != None and Game.gamepadInputs[21] == 1):
            ...
            if self.options_mainmenu == 1:
                if Game.playerLoaded == False:
                    Game.player = Player((640, 1780), Game.jsonPath, Game.playerPath, Game.camera)
                    Game.playerLoaded = True
